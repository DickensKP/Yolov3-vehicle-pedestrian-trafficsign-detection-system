...
def get_combine_img(img_path,pedestrain_detector=pedestrain_detector):
    result = pedestrain_detector.object_detection(paths=[img_path])
...
combine_image_to_video('yolov3_pedestrian_detect_output/', 'analysis.mp4', fps)
